...
def load_processed_data_from_zip(zip_path: str | Path, prinpath: bool = False) -> Tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame, Dict[str, Any], Dict[str, Any] ]:
    """
    ...
    artifacts:Dict[str, Any] = joblib.load(os.path.join(temp_dir, 'artifacts.joblib'))
    ...
    return train_final, val_final, test_final, artifacts, metadata